...
SECRET_KEY = 'n7wbi(_e=3az-oa_)-9@*49k5@sx%!8fotkh!3%+t$f2@llhu4'
...
# keep the default ModelBackend that is used to authenticate with username and
# password, and include our own email-based authentication backend.
